...
df <- read.csv("~/CursosML/machinelearning-az-master/datasets/Part 3 - Classification/Section 18 - Naive Bayes/Social_Network_Ads.csv")
df <- df[, 3:5]
# Codificamos la variable de clasificación como factor
...
y_pred <- predict(nb, newdata = test_set)
...
plot(set[, -3],
     main = 'Naive Bayes (Conjunto de Training)',
