...
df = pd.read_csv("/home/guillem/CursosML/machinelearning-az-master/datasets/Part 3 - Classification/Section 20 - Random Forest Classification/Social_Network_Ads.csv")
